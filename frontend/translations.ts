...
export const TRANSLATIONS = {
  en: {
    ...
    forgotPasswordSuccess: 'Temporary password sent or generated!',
  ...
  zh: {
    ...
    forgotPassword: '忘記密碼？',
    backToLogin: '返回登入',
    sendTempPassword: '寄送臨時密碼',
    changePassword: '變更密碼',
    oldPassword: '原密碼',
    newPassword: '新密碼',
    confirmNewPassword: '確認新密碼',
    passwordsDoNotMatch: '新密碼與確認密碼不符',
    changePasswordSuccess: '密碼變更成功！',
    forgotPasswordSuccess: '臨時密碼已成功寄出或生成！',
  ...
  ja: {
    ...
    forgotPasswordSuccess: '臨時パスワードが送信または生成されました！',
  ...
  ko: {
    ...
    forgotPasswordSuccess: '임시 비밀번호가 전송 또는 생성되었습니다!',
